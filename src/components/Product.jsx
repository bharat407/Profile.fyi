...
const Product = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-white hover:scale-110 transition-all duration-300 ease-in gap-3 p-4 w-[90%] mt-10 ml-3 rounded-xl shadow-[rgba(0,_0,_0,_0.44)_0px_3px_8px] hover:shadow-[0px_0px_95px_53px_#00000024]">
      <div>
